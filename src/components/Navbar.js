            ...
            <div className="navbar bg-gradient-to-b from-[#702b2b] via-[#9d0505] to-[#8a1818] shadow-lg z-50 border-b-2 text-white border-b-gray-600">
                <div className="navbar-start">
                    <div className="dropdown ">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-10 p-2 shadow bg-base-100 rounded-box w-52 bg-black">
                            <li><a href='/dashboard'>Dashboard</a></li>
                            <li><a href='/register-user'>Register New User</a></li>
                            <li><a href="/register-ca">Register Campus Ambassador</a></li>
                            <li><a href='/verify-workshop-payment'>Verify workshop Payments</a></li>
                            <li><a href='/verify-event-payment'>Verify event Payments</a></li>
                            <li><a href='/workshop-cash-payment'>Workshop Cash Payment</a></li>
                            <li><a href='/event-cash-payment'>Event Cash Payment</a></li>
                            ...
                            <li><a href='/event-payments'>Event Payments</a></li>
