      ...
      <div className="w-full p-6 m-auto  rounded-md shadow-md lg:max-w-xl">
        ...
        <form className='mt-6'>
          <div className='mb-2'>
            ...
            <input type="email" name="email" value={data.email} onChange={handleChange} className='block w-full px-4 py-2 mt-2 text-purple-700 bg-white border rounded-md focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40' rquired></input><br></br>
          </div>
          <div>
