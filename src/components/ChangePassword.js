      ...
      <div className="w-full p-6 m-auto rounded-md shadow-md lg:max-w-xl">
        ...
        <form className='mt-6'>
          <div className='mb-2'>
            ...
            <input type="password" name="password" value={data.password} onChange={handleChange} className="block w-full px-4 py-2 mt-2  text-red-800 bg-white border rounded-md focus:border-red-700 focus:ring-red-700 bg-white border rounded-md  focus:outline-none focus:ring focus:ring-opacity-40" required></input><br></br>
          </div>
          <div>
            <label className="block text-sm font-semibold">New Password:</label>
            <input type="password" name="newpassword" value={data.newpassword} onChange={handleChange} className='block w-full px-4 py-2 mt-2 text-red-800 bg-white border rounded-md focus:border-red-700 focus:ring-red-700 bg-white border rounded-md  focus:outline-none focus:ring focus:ring-opacity-40' required></input><br></br>
          </div>
          {error &&
