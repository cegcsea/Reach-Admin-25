      ...
      <div className="flex flex-row items-center text-white">
        <div className="dropdown">
          <div
            tabIndex={0}
            role="button"
            className="btn m-1 bg-black text-black"
          >
            <svg
          ...
          <ul
            tabIndex={0}
            className="dropdown-content z-10 menu p-2 shadow bg-base-100 rounded-box w-52 bg-black"
          >
            <li>
              <button onClick={() => setFilter("abacusId")}>Abacus Id</button>
            </li>
            <li>
              <button onClick={() => setFilter("mobile")}>Mobile Number</button>
            </li>
            <li>
        ...
        <input
          ...
          className="text-red-800 input input-bordered w-full "
          value={filterData}
